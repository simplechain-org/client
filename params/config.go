...
var (
	...
	// and accepted by the Ethereum engine developers into the Ethash consensus.
	//
	...
	// and accepted by the Ethereum engine developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
// CheckpointOracleConfig represents a set of checkpoint contracts(which acts as an oracle)
...
// ChainConfig is the engine config which determines the blockchain settings.
//
