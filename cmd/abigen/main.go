...
import (
	...
	"github.com/simplechain-org/client/cmd/utils"
	"github.com/simplechain-org/client/common/compiler"
	"github.com/simplechain-org/client/crypto"
	"github.com/simplechain-org/client/internal/flags"
...
var (
	...
	abiFlag = cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the Ethereum contracts ABI json to bind, - for STDIN",
	}
	binFlag = cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the Ethereum contracts bytecode (generate deploy method)",
	}
	...
	solFlag = cli.StringFlag{
		Name:  "sol",
		Usage: "Path to the Ethereum contracts Solidity source to build and bind",
	}
	...
	vyFlag = cli.StringFlag{
		Name:  "vy",
		Usage: "Path to the Ethereum contracts Vyper source to build and bind",
	}
...
func abigen(c *cli.Context) error {
	...
	if c.GlobalString(abiFlag.Name) != "" {
		...
		case c.GlobalIsSet(jsonFlag.Name):
			...
			if err != nil {
				utils.Fatalf("Failed to read contracts information from json output: %v", err)
			}
		}
		// Gather all non-excluded contracts for binding
	...
	// Generate the contracts binding
