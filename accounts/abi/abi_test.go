...
// The test is based on the following contracts:
//
//	contracts TestConstructor {
...
// TestUnpackEvent is based on this contracts:
//
//	contracts T {
...
// The test runs the abi of the following contracts.
//
//	contracts DuplicateEvent {
