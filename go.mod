module github.com/simplechain-org/client

go 1.16

require (
	github.com/Beyond-simplechain/foundation v1.0.0 // indirect
	...
	github.com/simplechain-org/go-simplechain v1.0.6-0.20220901063853-a9feac390775 // indirect
