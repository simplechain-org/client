...
// https://github.com/simplechain-org/client/pull/15549.
...
// See https://github.com/simplechain-org/client/pull/15225#issuecomment-380191512
...
//
// See https://github.com/simplechain-org/client/issues/20106.
...
// while changing the internals of StateDB. The workflow is that a contracts is
...
func TestDeleteCreateRevert(t *testing.T) {
	// Create an initial state with a single contracts
	state, _ := New(common.Hash{}, NewDatabase(rawdb.NewMemoryDatabase()), nil)
	...
	if state.getStateObject(addr) != nil {
		t.Fatalf("self-destructed contracts came alive")
	}
}
