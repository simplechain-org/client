...
// including all of the contracts code and contracts state tries.
type NodeIterator struct {
	state *StateDB // State being iterated

	stateIt trie.NodeIterator // Primary iterator for the global state trie
	dataIt  trie.NodeIterator // Secondary iterator for the data trie of a contracts

	accountHash common.Hash // Hash of the node containing the account
	codeHash    common.Hash // Hash of the contracts source code
	code        []byte      // Source code associated with a contracts
