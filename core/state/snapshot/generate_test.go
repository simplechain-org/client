...
import (
	...
	"github.com/simplechain-org/client/ethdb/memorydb"
...
// - the contracts with empty storage root but has storage entries in the disk
// - the contracts with non empty storage root but empty storage slots
// - the contracts(non-empty storage) misses some storage slots
//   - miss in the beginning
//   - miss in the middle
//   - miss in the end
//
// - the contracts(non-empty storage) has wrong storage slots
//   - wrong slots in the beginning
//   - wrong slots in the middle
//   - wrong slots in the end
//
// - the contracts(non-empty storage) has extra storage slots
