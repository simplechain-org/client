...
import (
	...
	"github.com/simplechain-org/client/params"
...
// Re-definition in engine/types/receipt.go.
...
func ReadBlock(db ethdb.Reader, hash common.Hash, number uint64) *types.Block {
	...
	if len(body.AdditionalData) > 0 {
		return types.NewBlockWithAdditionalData(header, body.Transactions, body.Uncles, body.AdditionalData)
	}
...
// WriteAncientBlocks WriteAncientBlock writes entire block data into ancient store and returns the total written size.
